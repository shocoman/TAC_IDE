...
class OptimizationChooseDialog : public wxDialog
{
	...
	public:
		...
		OptimizationChooseDialog( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Optimization Choose Window"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 1000,760 ), long style = wxDEFAULT_DIALOG_STYLE );
...
class OptimizationShowDialog : public wxDialog
{
	...
	public:
		...
		OptimizationShowDialog( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Optimization Description Window"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 640,740 ), long style = wxDEFAULT_DIALOG_STYLE );
