  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_array_assignment = 49,                 // array_assignment
        S_var_declaration = 50,                  // var_declaration
        S_label = 51,                            // label
        S_term = 52,                             // term
        S_stmts = 53,                            // stmts
        S_stmt = 54,                             // stmt
        S_mb_newline = 55,                       // mb_newline
...
#line 2197 "../src/utilities/parser/compiled_parser/parser.hpp"
